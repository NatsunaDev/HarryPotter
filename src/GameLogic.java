...
public class GameLogic {
    ...
    public static void fight(Wizard wizard, Enemy enemyName) {//Fonction de combat
        ...
        int input = 0;
        do {
            System.out.println("Quelle attaque souhaitez vous utilisez");//On demande à l'utilisateur quelle attaque il veut utiliser
            System.out.println("Vos attaques disponible : ");//On affiche les attaques disponible
            int numOfQuestion = 1;
            int numOfIndex = 0;
            ...
            if (wizardAttack > 0){
                ...
                System.out.println("Votre attack a touché, il reste lui " + enemyName.hp + "");//On affiche les points de vie restant à l'ennemie
            }
            else {
                System.out.println("Votre attack a échoué");//Si l'attaque a échoué
            }
            if(enemyName.hp >= 0 ){//Si l'ennemie a encore des points de vie
                System.out.println(enemyName.name+ " vous attaque !");//On affiche que l'ennemie attaque
            ...
            System.out.println("Il vous reste "+ wizard.hp + "hp");//On affiche les points de vie restant à l'utilisateur
        ...
        if(wizard.hp > 0) {//Si l'utilisateur a encore des points de vie
            ...
            Separator(24);
            Separator(24);
            System.out.println("Vous passez au niveau " + wizard.lvl);//On affiche le niveau de l'utilisateur
            Separator(24);
            Separator(24);
        }else {
